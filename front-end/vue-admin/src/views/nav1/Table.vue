    ...
    <el-table :data="news"  highlight-current-row  v-loading="listLoading"  @selection-change="selsChange"  style="width: 100%" >
      ...
      <el-table-column :show-overflow-tooltip="true" prop="sign" label="标识" width="100" sortable >
        <template slot-scope="scope">
          <span v-if="scope.row.sign === true" style="color: green">真</span>
          <span v-else-if="scope.row.sign === false" style="color: red" >假</span>
          <span v-else style="color: black">待检测</span>
        </template>
      </el-table-column>
      <el-table-column :show-overflow-tooltip="true" prop="text" label="内容" min-width="180" sortable>
      </el-table-column>
